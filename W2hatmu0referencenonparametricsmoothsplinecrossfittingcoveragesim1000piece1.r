...
save(DRMSE, file=paste("W2mu0referencenonparametricsmoothingsplinecrossfittingsplit", K, "mediannumber", mediannumber,"DRMSE_n", n, "_p", p, "_piece", piece, ".dat",sep=""))

save(DRmedianbias, file=paste("W2mu0referencenonparametricsmoothingsplinecrossfittingsplit", K, "mediannumber", mediannumber, "DRmedianbias_n", n, "_p", p, "_piece", piece, ".dat",sep=""))

save(DRmediancoverage, file=paste("W2hatmu0referencenonparametricsmoothingsplinecrossfittingsplit", K, "mediannumber", mediannumber, "DRmediancoverage_n", n, "_p", p, "_piece", piece, ".dat",sep=""))
