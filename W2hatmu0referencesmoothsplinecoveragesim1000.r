### This code is the data adaptive doubly robust estimator for Scenario 1, 
...
save(DRMSE, file=paste("W2hatmu0referencesmoothsplineDRMSE_n", n, "_p", p, ".dat",sep=""))

save(DRmedianbias, file=paste("W2hatmu0referencesmoothsplineDRmedianbias_n", n, "_p", p, ".dat",sep=""))

save(DRcoverage, file=paste("W2hatmu0referencesmoothsplineDRcoverage_n", n, "_p", p, ".dat",sep=""))
